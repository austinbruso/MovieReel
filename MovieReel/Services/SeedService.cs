...
namespace MovieReel.Services
{
    public class SeedService
    {
        ...
        private async Task SeedRolesAsync()
        {
            ...
            var adminRole = _appSettings.MovieReelSettings.DefaultCredentials.Role;
        ...
        private async Task SeedUsersAsync()
        {
            ...
            var credentials = _appSettings.MovieReelSettings.DefaultCredentials;
        ...
        private async Task SeedCollections()
        {
            ...
            {
                Name = _appSettings.MovieReelSettings.DefaultCollection.Name,
                Description = _appSettings.MovieReelSettings.DefaultCollection.Description
            });
