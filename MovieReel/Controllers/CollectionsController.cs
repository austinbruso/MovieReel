...
namespace MovieReel.Controllers
{
    public class CollectionsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var defaultCollectionName = _appSettings.MovieReelSettings.DefaultCollection.Name;
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Collection collection)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (collection.Name == _appSettings.MovieReelSettings.DefaultCollection.Name )
                    {
